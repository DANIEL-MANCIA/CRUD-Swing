...
public class PersonaDAO {
    ...
    // Se inicializa del dafaulttablemodel basado en el modelo de la tabla del formulario vista
    ...
    public List listar(){
        ...
        try{
            ...
            while(rs.next()){
                ...
                //se utilizan los set y get para asignar los valores otenidos de la consulta datos
                p.setId(rs.getInt(1));
