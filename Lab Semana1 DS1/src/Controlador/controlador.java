...
public class controlador implements ActionListener{
    ...
    public void Listar(JTable tabla){
        ...
        object[0] = lista.get(i).getId(); // obtiene el id y lo asigna el la posicion del areglo
    ...
    public void agregar() {
        // Validar que los campos estén llenos antes de agregar
        if (!validarCamposLlenos()) {
            return; // Si los campos no están llenos, se detiene el método
        }
